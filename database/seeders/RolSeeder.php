...
class RolSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'docentes.show'])->syncRoles([$Admin, $Carr]);
        ...
        Permission::create(['name' => 'extraordinarios.show'])->syncRoles([$Admin, $Carr]);
        ...
        Permission::create(['name' => 'titulares.show'])->syncRoles([$Admin, $Carr]);
        ...
        Permission::create(['name' => 'consultores.show'])->syncRoles([$Admin, $Carr]);
        ...
        Permission::create(['name' => 'designacions.show'])->syncRoles([$Admin, $Carr]);
        ...
        Permission::create(['name' => 'estudios.show'])->syncRoles([$Admin, $Carr]);
